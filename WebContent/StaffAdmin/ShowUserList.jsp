...
<%List<User>user_List = new UserDAOImpl().ListAllUsers();%>
<br>
<br>
<center>
...
<tr>
<td class="align-middle"><%=obj.getF_name() %></td>
<td class="align-middle"><%=obj.getL_name() %></td>
<td class="align-middle"><%=obj.getGender()%></td>
<td class="align-middle"><%=obj.getE_Mail()%></td>
<td class="align-middle"><%=obj.getContact_num()%></td>
<td class="align-middle"> <%=obj.getUserId()%></td>
<td class="align-middle"><%=obj.getPassword()%></td>
</tr>
<%} %>
</table>
</body>
